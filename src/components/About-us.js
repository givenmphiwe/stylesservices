        ...
        <div className="container">
          <div className="row">
            <div className="title">
              <h1>Our team</h1>
              <p>
                There are no secrets to sucess,It is the results of preparation,
                hard work,and learning from setbacks
              </p>
            </div>
          </div>
          ...
          <div className="team-card">
            <div className="card">
              ...
              <div className="content-1">
                ...
                <p>
                  The strength in our team and our ability to deal with
                  adversities is what makes us a great company
                </p>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="content-1">
                ...
                <p>
                  We will accelerate our business activities to safeguard Our
                  clients and staff
                </p>
              </div>
            </div>
